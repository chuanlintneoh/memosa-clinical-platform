...
4. [BUG] Stability in case creation (backend error handling in AI inference service after timeout)
...
4. /Nofix [ENHANCEMENT] Using existing email for account registration
...
14. [ENHANCEMENT] Password for user registration, ideally different for user type and user
15. [ENHANCEMENT] Suggest that there is a next button to move onto the next image among the nine images instead of checking the dropdown - AN
16. [ENHANCEMENT] How would you search if you did not copy the case ID? - SC,AN
17. [ENHANCEMENT] Is it possible to have save as draft for clinician diagnosis? - SC, AN
18. [ENHANCEMENT] Case submission and export bundle takes a while - AN

[BUG] Cannot find cases after submission - SC (TBC)
[BUG] Search not working - SC, AN [see screenshot] (TBC)
[BUG] Could not test case editing, as cannot search cases after submitting because search not working - SC, AN (TBC)
[BUG] I don't see the cases that I submitted with the study coordinator account. Am I supposed to? - SC,AN (TBC)
